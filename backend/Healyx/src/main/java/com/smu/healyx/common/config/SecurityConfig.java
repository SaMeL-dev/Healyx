...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // 병원별 리뷰 조회 + 최신 리뷰 미리보기: 비로그인 허용 / 나머지 리뷰 API: 인증 필요
                .requestMatchers(HttpMethod.GET, "/api/reviews/hospitals/**", "/api/reviews/latest").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://jwejweiya.com", "http://localhost:8080", "https://ljsoung.github.io"));
